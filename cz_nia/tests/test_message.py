...
class TestIdentificationMessage(TestCase):
    ...
    def test_create_message_address(self):
        message = IdentificationMessage(
            {"first_name": "Eda", "last_name": "Tester", "birth_date": datetime.date(2000, 5, 1), "address": "1"}
        ).create_message()
        namespace = "urn:nia.ztotozneni/request:v3"
        expected = {
    ...
    def test_create_message_address_empty(self):
        message = IdentificationMessage(
            {"first_name": "Eda", "last_name": "Tester", "birth_date": datetime.date(2000, 5, 1), "address": ""}
        ).create_message()
        namespace = "urn:nia.ztotozneni/request:v3"
        expected = {
            QName(namespace, "Jmeno"): "Eda",
    ...
    def test_create_message_address_none(self):
        message = IdentificationMessage(
            {"first_name": "Eda", "last_name": "Tester", "birth_date": datetime.date(2000, 5, 1), "address": None}
        ).create_message()
        namespace = "urn:nia.ztotozneni/request:v3"
        expected = {
            QName(namespace, "Jmeno"): "Eda",
...
class TestWriteAuthenticatorMessage(TestCase):
    ...
    def test_create_message_unverified(self):
        message = WriteAuthenticatorMessage(
            {
                "identification": "some_vip",
...
class TestChangeAuthenticatorMessage(TestCase):
    ...
    def test_create_message(self):
        message = ChangeAuthenticatorMessage(
            {
                "identification": "some_vip",
                "level_of_authentication": "High",
                "state": "Aktivni",
                "pseudonym": "some_pseudonym",
                "message": "some message to the authorities",
            }
        ).create_message()
